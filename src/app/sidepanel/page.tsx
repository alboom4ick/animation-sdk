  ...
  return (
    <>
      <div>
        ...
        look at an animation involving your favorite color. <br />
        The cloudProjectNumber is {CLOUD_PROJECT_NUMBER} <br />
        The mainStageUrl is {MAIN_STAGE_URL} <br />
        The activitySidePanelUrl is {ACTIVITY_SIDE_PANEL_URL} <br />
      </div>
